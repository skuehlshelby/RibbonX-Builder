...
Namespace Controls
    ...
    Friend NotInheritable Class EditBox
...
#Region "Events"
        ...
        Public Custom Event Changing As EventHandler(Of CancelableEventArgs(Of String)) Implements IEditBox.Changing
        ...
        Public Custom Event Changed As EventHandler(Of EventArgs(Of String)) Implements IEditBox.Changed
...
#End Region
        ...
        Public Overrides Function Clone() As Object
            Return New EditBox(CType(Attributes.Clone(), IPropertyCollection), Tag)
        End Function

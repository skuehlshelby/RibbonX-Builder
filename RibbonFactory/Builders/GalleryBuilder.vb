...
Namespace Builders
    ...
    Friend NotInheritable Class GalleryBuilder
        ...
        Private Function Large(callback As FromControl(Of Enums.ControlSize)) As IGalleryBuilder Implements IGalleryBuilder.Large
            LargeBase(callback)
            Return Me
        End Function
        ...
        Private Function Normal(callback As FromControl(Of Enums.ControlSize)) As IGalleryBuilder Implements IGalleryBuilder.Normal
            NormalBase(callback)
            Return Me
        End Function

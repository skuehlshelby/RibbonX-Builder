...
#Region "Actions"
        ...
        Public Sub ThatDoes(Of T As RibbonElement)(action As Action(Of T), callback As OnAction)
        ...
        Public Sub ThatDoes(Of T As RibbonElement)(action As Action(Of T), callback As TextChanged)
